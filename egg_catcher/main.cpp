...
int a=600,b=630; // for default size of the screen
int s=0;
...
//to recognize the keyboard input
...
//console regarding the game description
void prompt()
{
    cout << endl << endl;
    cout << " ---------------------------------------------------------------------------------" << endl;
...
int main(int argc,char **argv)
{
    ...
    glutKeyboardFunc(keys); //calling keys function
    glutPassiveMotionFunc(set_basket); //calling set_basket function
